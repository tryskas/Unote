    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Etudiant'), ('teacher', 'Professeur'), ('admin', 'Administration')], default='student', max_length=20)),
        ...
        migrations.AddField(
            model_name='group',
            name='users',
            field=models.ManyToManyField(related_name='users_groups', through='users.GroupMembership', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Lesson',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('presence', models.CharField(choices=[('P', 'Present'), ('A', 'Absent'), ('D', 'Retard')], max_length=1)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.room')),
        ...
        migrations.AddField(
            model_name='subject',
            name='ues',
            field=models.ManyToManyField(related_name='Subjects', to='users.ue'),
        ),
        migrations.AddField(
            model_name='group',
            name='ues',
            field=models.ManyToManyField(related_name='groups', to='users.ue'),
        ),
    ]
