    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'student'), ('teacher', 'Professor'), ('admin', 'Administrateur')], default='student', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('users', models.ManyToManyField(related_name='users_groups', to=settings.AUTH_USER_MODEL)),
                ('ues', models.ManyToManyField(related_name='groups', to='users.ue')),
            ],
        ),
        migrations.CreateModel(
            name='Lesson',
