...
def attendance_teacher(request):
    ...
    return render(request,'administration/attendance/attendance_teacher.html',context)
...
def attendance_student(request):
    ...
    return render(request,'administration/attendance/attendance_student.html',context)
...
def attendance_admin(request):
    ...
    return render(request,'administration/attendance/attendance_admin.html')
...
def attendance_of(request,username):
    ...
    return render(request,'administration/attendance/attendance_of.html',context)
...
def class_call(request, id):
    ...
    return render(request,'administration/attendance/class_call.html',context)
# -----------------------------------------------------------------------------------
